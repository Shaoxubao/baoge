...
public class DistributedLock {
    ...
    public DistributedLock(String lockRoot, String connectionString, int sessionTimeout) throws Exception {
    ...
    public synchronized boolean lock() {
        ...
        try {
            ...
            lockId = zk.create(lockRoot + "/", data, ZooDefs.Ids.OPEN_ACL_UNSAFE, CreateMode.EPHEMERAL_SEQUENTIAL);
            ...
            SortedSet<String> sortedNode = new TreeSet<>();
